...
if(!isNaN(name.value)) 
{
   error = " <font color='red'>!please only character allowed</font> ";
 ...
 {
  error = " <font color='red'>! ** mobile number must be 10 digit</font> ";
  document.getElementById( "numbererror" ).innerHTML = error;
  return false;
 }

else if(isNaN(number.value)){
  error = " <font color='red'>! ** mobile number must not have characters</font> ";
  document.getElementById( "numbererror" ).innerHTML = error;
  return false;
}
  ...
  if(password.value.length >= 10) 
{
 ...
 {
  error = " <font color='red'>!Confirm Password Not Match.</font> ";
  document.getElementById( "cpassworderror" ).innerHTML = error;
  return false;
 }
